...
# to the dictionary keys, but you have to extract the 
# attributes from the "insr" tag
...
def test(article_file):
    solution = [{'insr': ['I1'], 'fnm': 'Omer', 'snm': 'Mei-Dan',
                ...
                {'insr': ['I3', 'I5'], 'fnm': 'Gideon', 'snm': 'Mann',
                'email': 'gideon.mann.md@gmail.com'
                 },
                {'insr': ['I6'], 'fnm': 'Barnaby', 'snm': 'Clarck',
                'email': 'barns.nz@gmail.com'
                 },
                {'insr': ['I7'], 'fnm': 'Eugene', 'snm': 'Kots',
